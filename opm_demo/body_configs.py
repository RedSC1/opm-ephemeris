...
CONFIGS: dict[str, BodyConfig] = {
    ...
    "emb": BodyConfig(
        ...
        notes="Validated with fitted-Sun composition.",
    ),
    "mars": BodyConfig(
        body="mars",
        center="ssb",
    ...
    "jupiter": BodyConfig(
        ...
        notes="Keep f=0.00; f=0.01 slightly worsened 7-epoch worst max.",
    ),
    "saturn": BodyConfig(
        body="saturn",
        center="ssb",
    ...
    "uranus": BodyConfig(
        ...
        notes="600-year split candidate; d30 reduces outer-planet tail for negligible size cost.",
    ),
    "neptune": BodyConfig(
        body="neptune",
        center="ssb",
        ...
        notes="600-year split candidate; d30/q3.5 brings the tail under ~0.0005 arcsec.",
    ),
    "pluto": BodyConfig(
        body="pluto",
        center="ssb",
        ...
        notes="600-year split candidate; selected over d28/q4.0 for a cleaner Pluto tail at tiny size cost.",
    ),
    "moon": BodyConfig(
        body="moon",
        center="earth",
